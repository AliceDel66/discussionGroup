...
| 开发任务包 | Cursor | `projects/<slug>/plans/plan.md` · `frontend-plan.md`（前端） |
...
└── projects/                     # 【核心】所有项目归档
    ...
    └── <project-slug>/           # 单个项目大文件夹
        ...
        ├── plans/plan.md         # 后端 Codex 任务（可选 frontend-plan.md）
...
| 项目 | 目录 | Spec | Plan | 状态 |
|------|------|------|------|------|
| RepPilot 医药代表智能助手 | [pharma-rep-agent](./projects/pharma-rep-agent/) | [spec](./projects/pharma-rep-agent/product/spec.md) | [plan](./projects/pharma-rep-agent/plans/plan.md) · [frontend](./projects/pharma-rep-agent/plans/frontend-plan.md) | L2 · 前端重构优先 |
| BidPilot 多模式招标工作台 | [pharma-bid-agent](./projects/pharma-bid-agent/) | [spec](./projects/pharma-bid-agent/product/spec.md) | [plan](./projects/pharma-bid-agent/plans/plan.md) | L3 部分可开发 |
| 曜承 HR Agent 招聘初筛助手 | [hr-agent](./projects/hr-agent/) | [spec](./projects/hr-agent/product/spec.md) | [plan](./projects/hr-agent/plans/plan.md) | L3 工程完结 |
